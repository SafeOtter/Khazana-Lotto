...
contract KhazanaLotto is Context, IERC20, Ownable {
    ...
    string private _name = "Khazana";
    string private _symbol = "KHZLT";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 5;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _lottoFee = 9;
